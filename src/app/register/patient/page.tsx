      ...
      <div className="w-full max-w-lg">
        ...
        >
          ...
          <p style={{
            ...
            Inizia il tuo percorso di salute digitale
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="w-full px-4 py-3 rounded-lg border transition-all duration-150 focus:outline-none focus:ring-2 focus:border-green-500 focus:ring-green-200"
                  style={{
                    borderColor: '#BDC3C7',
                    fontSize: '16px',
                    color: '#2C3E50'
            ...
            <div>
              ...
              <input
                ...
                placeholder="maria.bianchi@email.com"
                value={email}
